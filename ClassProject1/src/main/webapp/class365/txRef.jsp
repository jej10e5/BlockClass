...
<div id="showScroll" class="blc_container">
	<div class="receipt">
		...
		<div class="survey bold">
			<p>TX ID #</p>
			<p class="surveyID" style="margin-left:30px;">${txid}</p>
		</div>
		
		<div class="creditDetails">
			<p>Transaction Details &nbsp;&nbsp;&nbsp;&nbsp; ****************</p>
			<p>from:</p> 
			<p style="width:200px; word-wrap: break-word;">${from}</p>
			<p>to:</p>
			<p style="width:200px; word-wrap: break-word;">${to}</p>
			<p>price: ${price} WON</p>
			<p>item: ${item}</p>
			<p>sig:</p> 
			<p style="width:200px; word-wrap: break-word;">${sig}</p>
		</div>
